...
For develop installation, visit our [GitHub repository](https://github.com/Krebslabrep/SingleMoleculeFootprinting).
```{r, eval=F}
...
## Define arguments
```{r, echo=FALSE}
FileAbsPath = paste0(.libPaths()[1], "/SingleMoleculeFootprinting/extdata/example_NRF1pair_amplicon.bam")

Qinput = system.file("extdata", "QuasR_input_pairs.txt", package = "SingleMoleculeFootprinting", mustWork = T)
Qinput_tsv = suppressMessages(readr::read_delim(Qinput, delim = "\t"))
Qinput_tsv$FileName = FileAbsPath
readr::write_delim(x = Qinput_tsv, file = paste0(.libPaths()[1], "/SingleMoleculeFootprinting/extdata/QuasR_input_pairs.txt"), delim = "\t")
```
